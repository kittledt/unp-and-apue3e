...
main()
{
	...
	set_sem_value( semset_id, 0, 0);	/* set counters	*/  //no.1
	set_sem_value( semset_id, 1, 0);	/* both to zero */  //no.2
...
{
    /* before write share mem, should meet below conditon 0 and 1   */
	...
	actions[1].sem_flg = SEM_UNDO;	/* auto cleanup	when process exit	*/
