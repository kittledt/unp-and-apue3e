...
#include "apue.h"
#include <fcntl.h>
#include <stropts.h>	//FMNAMESZ value =  8。
//#include <sys/conf.h>
...
main(int argc, char *argv[])
{
     ...
     */
    list.sl_modlist = calloc(nmods, sizeof(struct str_mlist));		//array of str_mlist ,  num = nmodes, first pointer to list.sl_modlist
